  ...
  return (
    <Layout>
      <Wrapper>
        <Content>
          <Section>
            <SectionHeader>AGBs</SectionHeader>
            <Header>1. Geltungsbereich</Header>
            <p>
              Diese Allgemeinen Geschäftsbedingungen (AGB) gelten für die
              Teilnahme an dem Festival "Klein und Haarig", das vom Verein
              "Bunte Platte e.V." veranstaltet wird. Mit der Anmeldung zum
            ...
            <p>
              ...
              Veranstalter:innen übernehmen keine Haftung für verloren gegangene
              oder gestohlene Tickets.
            </p>
            <Header>3. Rücktritt und Stornierung</Header>
            <p>
              Die Käufer:innen können bis zu acht Wochen vor Festivalbeginn
              schriftlich vom Kaufvertrag zurücktreten. In diesem Fall wird eine
              Stornogebühr in Höhe von 25% des Ticketpreises erhoben. Bei
              späterem Rücktritt oder Nichterscheinen wird keine Rückerstattung
              des Ticketpreises gewährt. Die Veranstalter:innen behalten sich
              das Recht vor, das Festival aus wichtigem Grund oder höherer
              Gewalt (Wetterbedingungen, Naturereignisse oder anderen Umständen)
              abzusagen oder zu verschieben. In diesem Fall werden die
              Ticketpreise in voller Höhe erstattet. Weitergehende Ansprüche der
              Käufer:innen sind ausgeschlossen.
            </p>
            ...
            <p>
              ...
              Schäden sind auf vorsätzliches oder grob fahrlässiges Handeln der
              Veranstalter:innen zurückzuführen. Die Käufer:innen haften für von
              ihnen verursachte Schäden.
            </p>
            <Header>6. Altersbeschränkung</Header>
            <p>
              Das Festival "Klein und Haarig" ist ausschließlich für Personen ab
              18 Jahren zugelassen. Teilnehmer:innen, die das 18. Lebensjahr
              noch nicht vollendet haben, dürfen nur in Begleitung einer
              volljährigen Person teilnehmen. Die Veranstalter:innen behalten
              sich vor, bei Vorlage eines gültigen Ausweises das Alter der
              Teilnehmer:innen zu überprüfen. Teilnehmer:innen, die das 18.
              Lebensjahr noch nicht vollendet haben und ohne Begleitung einer
              volljährigen Person anreisen, werden vom Festival ausgeschlossen.
              In diesem Fall wird der Kaufpreis des Festivaltickets nicht
              erstattet.
            </p>
            ...
            <p>
              ...
              Veranstaltung sichtbar am Handgelenk zu tragen und berechtigt zum
              einmaligen Eintritt auf das Festivalgelände. Sollten die
            ...
            <p>
              ...
              Die unwirksame Bestimmung wird durch eine wirksame Bestimmung
              ersetzt, die dem wirtschaftlichen Zweck der unwirksamen Bestimmung
              möglichst nahekommt. Das Gleiche gilt für eventuelle
              Regelungslücken in diesen AGB.
            </p>
            ...
            <p>
              ...
              angemessene Regelung als vereinbart, die dem Zweck der unwirksamen
              Bestimmung am nächsten kommt. Die Veranstalter:innen behalten sich
              das Recht vor, diese AGB jederzeit zu ändern. Die Teilnehmer:innen
              werden über Änderungen der AGB rechtzeitig informiert. Die
              Änderungen gelten als akzeptiert, wenn die Teilnehmer:innen nicht
              innerhalb von 14 Tagen nach Bekanntgabe der Änderungen
              widersprechen. Der Gerichtsstand für alle Streitigkeiten aus
              diesen AGB ist der Sitz der Veranstalter:innen.
            </p>
          </Section>
        </Content>
      </Wrapper>
