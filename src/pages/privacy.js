    ...
    <Wrapper>
      <Content>
        <Section>
          ...
          <Group>
            <Header>Datenerfassung auf dieser Website</Header>{" "}
            <h4>
          ...
          <Group>
            <Header>Analyse-Tools und Tools von Dritt&shy;anbietern</Header>{" "}
            <p>
        ...
        <Section>
          ...
          <Group>
            <Header>Externes Hosting</Header>{" "}
            <p>
            ...
            <p>
              STRATO AG
              <br />
              Pascalstra&szlig;e 10, 10587 Berlin
            </p>
          </Group>
        </Section>
        <Section>
          ...
          <Group>
            <Header>Hinweis zur verantwortlichen Stelle</Header>{" "}
            <p>
            ...
            <p>
              ...
              80799 M&uuml;nchen
              <br />
              Vertreten durch: Luca Prohl und Mareike Klau&szlig; (Vorstand)
            </p>
            <p>
              Telefon: &#91;Telefonnummer der verantwortlichen Stelle&#93;
              <br />
              E-Mail: info@bunte-platte.de
            </p>
            <p>
          ...
          <Group>
            <Header>Widerruf Ihrer Einwilligung zur Datenverarbeitung</Header>{" "}
            <p>
          ...
          <Group>
            <Header>Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</Header>{" "}
            <p>
          ...
          <Group>
            <Header>SSL- bzw. TLS-Verschl&uuml;sselung</Header>{" "}
            <p>
          ...
          <Group>
            <Header>Auskunft, L&ouml;schung und Berichtigung</Header>{" "}
            <p>
          ...
          <Group>
            <Header>Recht auf Einschr&auml;nkung der Verarbeitung</Header>{" "}
            <p>
        ...
        <Section>
          <SectionHeader>Datenerfassung auf dieser Website</SectionHeader>
          <Group>
          ...
          <Group>
            <Header>Anfrage per E-Mail, Telefon oder Telefax</Header>{" "}
            <p>
        ...
        <Section>
          ...
          <Group>
            <Header>Newsletter&shy;daten</Header>{" "}
            <p>
          ...
          <Group>
            ...
            <p>
              ...
              De Leon Ave NE, Suite 5000, Atlanta, GA 30308, USA. MailChimp ist
              ein Dienst, mit dem u.a. der Versand von Newslettern organisiert
              und analysiert werden kann. Wenn Sie Daten zum Zwecke des
              ...
              Der “Privacy-Shield” ist ein Übereinkommen zwischen der
              Europäischen Union (EU) und den USA, das die Einhaltung
              ...
              Newsletter besser an die Interessen der Empfänger anzupassen. Wenn
              Sie keine Analyse durch MailChimp wollen, müssen Sie den
              ...
              abbestellen. Die Datenverarbeitung erfolgt auf Grundlage Ihrer
              Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Sie können diese
              Einwilligung jederzeit widerrufen, indem Sie den Newsletter
              ...
              werden von uns bis zu Ihrer Austragung aus dem Newsletter
              ...
              . Abschluss eines Data-Processing-Agreements Wir haben ein sog.
              „Data-Processing-Agreement“ mit MailChimp abgeschlossen, in dem
              wir MailChimp verpflichten, die Daten unserer Kunden zu schützen
        ...
        <Section>
          <SectionHeader>Plugins und Tools</SectionHeader>
          <Group>
            <Header>Google Web Fonts (lokales Hosting)</Header>{" "}
            <p>
          ...
          <Group>
            ...
            <p>
              ...
              Die SoundCloud-Plugins erkennen Sie an dem SoundCloud-Logo auf den
              betroffenen Seiten.
            </p>{" "}
            <p>
