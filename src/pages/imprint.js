...
export default function Imprint() {
  return (
    <Wrapper>
      ...
      <p>
        Vereinsregister: [REGISTERNUMMER]
        <br />
      ...
      <p>
        ...
        <br />
        Luca Prohl &amp; Mareike Klau&szlig;
      </p>
      <h2>Kontakt</h2>
      <p>
        Telefon: 0177 6845755
        <br />
      ...
      <p>
        Berufsbezeichnung: [GESTEZLICHE BERUFSBEZEICHNUNG]
        <br />
        Zust&auml;ndige Kammer: [KAMMER]
        <br />
        Verliehen in: Deutschland
        <br />
        Es gelten folgende berufsrechtliche Regelungen: [BERUFSRECHTLICHE
        REGELUNGEN]
        <br />
        Regelungen einsehbar unter:{" "}
        <a
          href="http://[http://LINK-ZU-BERUFSRECHTLICHE REGELUNGEN.de]"
          target="_blank"
          rel="noopener noreferrer"
        >
          http://[http://LINK-ZU-BERUFSRECHTLICHE REGELUNGEN.de]
        </a>
      </p>
